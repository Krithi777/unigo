/**
 * RiderEmailEntryScreen — email entry for rider signup/login.
 * Replaces RiderPhoneEntryScreen. Sends a verification link via backend.
 */
...
import { sendRiderEmailVerification } from '../../services/authService';

type Nav = NativeStackNavigationProp<AuthStackParamList, 'RiderEmailEntry'>;

export default function RiderEmailEntryScreen() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      navigation.navigate('RiderEmailVerifyWaiting', { email: email.trim().toLowerCase() });
    } catch (err: any) {
      ...
      <KeyboardAvoidingView style={styles.kav} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.title}>Continue as Rider</Text>
