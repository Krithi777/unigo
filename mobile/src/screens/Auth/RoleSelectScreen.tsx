...
type EntryNavProp = NativeStackNavigationProp<AuthStackParamList, 'Entry'>;

export default function EntryScreen() {
  const navigation = useNavigation<EntryNavProp>();

  const goTo = (role: 'rider' | 'driver' | 'admin') => {
    navigation.navigate('EmailEntry', { entryRole: role });
  };
...
// Override card text color for driver card (white on purple bg)
// Applied via inline style on the title/sub inside cardDriver